    ...
    return (
        <View style={styles.BillsDue}>
            <ScrollView showsVerticalScrollIndicator={false}>
                ...
                >
                    <Bill PayerName={'Keells'} PayerType={'Shoping'} />
                    <Bill PayerName={'Pizza Hut'} PayerType={'Food'} />
                    <Bill PayerName={'Apple'} PayerType={'Shopping'} />
                    <Bill PayerName={'Keells'} PayerType={'Shoping'} />
                    <Bill PayerName={'Pizza'} PayerType={'Food'} />
                    <Bill PayerName={'Apple'} PayerType={'Shopping'} />
                    <Bill PayerName={'Keells'} PayerType={'Shoping'} />
                    <Bill PayerName={'Pizza'} PayerType={'Food'} />
                    <Bill PayerName={'Apple'} PayerType={'Shopping'} /><Bill PayerName={'Keells'} PayerType={'Shoping'} />
                    <Bill PayerName={'Pizza'} PayerType={'Food'} />
                    <Bill PayerName={'Apple'} PayerType={'Shopping'} />
