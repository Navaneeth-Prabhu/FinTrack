            ...
            <ScrollView contentContainerStyle={styles.scrollContent}>
                ...
                <View style={styles.historySection}>
                    ...
                    {transactions.length === 0 ? (
                        ...
                        transactions.filter(t => t.event_type === 'price_update').map(tx => (
                            <View key={tx.id} style={[styles.txItem, { backgroundColor: colors.card }]}>
                                <View>
                                    ...
                                    <Text style={[styles.txLabel, { color: colors.subtitle }]}>Manual Update</Text>
                                </View>
                                <View style={styles.txAmountContainer}>
                                    <Text style={[styles.txAmount, { color: colors.text }]}>{tx.price ? formatCurrency(tx.price) : 'N/A'}</Text>
                                </View>
                            </View>
                        ))
                    )}
